...
const DynamicTable = () => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-xl font-bold mb-4">Performance of Engaging Lectures/Practical</h1>
      ...
      <table className="min-w-full table-auto border-collapse border border-gray-200">
        <thead>
          <tr>
            ...
            <th className="border border-gray-200 p-2">Periods Alloted</th>
            <th className="border border-gray-200 p-2">Attended Periods</th>
            <th className="border border-gray-200 p-2">%Target Achieved</th>
